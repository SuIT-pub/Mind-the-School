...
label load_situations:
    ...
    $ register_situations(
        ...
        Situation("new_management", "New Management",
            ...
            # PHOTO: the office door — old brass plaque, a crooked printout taped over
            # half of it with the headmaster's name misspelled. Bookends nm_title_earned.
            Teaser(
                "nm_wrong_face",
                "Someone taped my name over the old headmaster's plaque — crooked, and misspelled at that.\nOut in the courtyard, two students were pointing my way and calling me the janitor.",
                OR(
                    EventSeenCondition(True, "nm_ghost_office_nameplate"),
                    EventSeenCondition(True, "nm_ghost_office_janitor"),
                ),
                interpretation="The door still can't spell me right, so why would the students know my face? To this place I'm a rumour, not a person yet. That's mine to fix — by being seen, not by being announced.",
                note_type="observation",
                image="images/journal/new_management/nm_wrong_face.webp",
                layout="photo_top",
            ),
            Teaser(
                "nm_private_line",
                "Emiko picked up the phone warm — too warm, almost caught off guard.\nThe moment footsteps crossed the outer office, her voice buttoned itself shut.",
                EventSeenCondition(True, "nm_ghost_office_private_line"),
                interpretation="So there are two of her — the one on a private line, and the one the corridor is allowed to hear. I'm not sure yet which one I'm meant to answer. Best tread carefully there.",
                note_type="suspicion",
            ),
            Teaser(
                "nm_frozen_hallway",
                "I said Yulan's name as I passed. She didn't lift her eyes from the folder.\nA page turned. The corridor didn't warm by a single degree.",
                EventSeenCondition(True, "nm_ghost_office_empty_corridor"),
                interpretation="That silence wasn't rudeness — it was the answer. Staff like her don't hand over a title because you've learned to say hello; you earn it off the page, in the work. Message received.",
                note_type="setback",
            ),
            # PHOTO: Miwa's open notebook on the desk, the week's page conspicuously
            # blank, her hands at the edges of the frame as if guarding it.
            Teaser(
                "nm_miwa_gap",
                "Miwa can't remember Tuesday morning at all — a clean blank where the week should be.\nHer notebook lay open on an empty page she kept both hands over.",
                EventSeenCondition(True, "nm_potion_hangover_miwa"),
                interpretation="The potion took a whole morning out of a child, and in all these weeks not one adult has thought to give it back to her. Nobody that age should have to guard a hole in her own memory alone. This one stays with me.",
                note_type="setback",
                image="images/journal/new_management/nm_miwa_gap.webp",
                layout="photo_left",
            ),
            Teaser(
                "nm_lily_shaken",
                "Lily set her mug down and it rattled — once — before she could still her own hand.\n\"Was last week real?\" she asked me. Nothing more than that.",
                EventSeenCondition(True, "nm_potion_hangover_lily"),
                interpretation="She wasn't after an answer so much as a witness — one steady person to say the thing out loud alongside her. The staff have been carrying last week in silence because no one gave them leave to name it. Maybe that's something I can hand them.",
                note_type="observation",
            ),
            # PHOTO: evidence shot — the broken green vial behind the bike rack,
            # cloudy glass catching the light, neck still sticky.
            Teaser(
                "nm_vial_found",
                "A broken green vial behind the bike rack, still tacky at the neck.\nIt carried the same sweet smell that hung in the corridor last Tuesday.",
                EventSeenCondition(True, "nm_potion_hangover_vial"),
                interpretation="So the evidence never actually left — it just stopped being obvious enough to trip over. Whatever happened here isn't finished, and the school's already learned to look straight past it. That's a habit I can't afford to catch.",
                note_type="insight",
                image="images/journal/new_management/nm_vial_found.webp",
                layout="photo_right",
            ),
            # PHOTO: a fanned stack of pink message slips on the desk, the top one
            # scrawled with a signature reading "a concerned observer".
            Teaser(
                "nm_pink_slips",
                "The pink message slips aren't tucked out of sight anymore — Emiko's stopped filing them where I won't look.\nOne was signed, simply, 'a concerned observer'.",
                OR(
                    EventSeenCondition(True, "nm_thresh_emiko_nudge"),
                    EventSeenCondition(True, "nm_thresh_district_letter"),
                ),
                interpretation="When Emiko stops hiding the pile, that's the alarm. Neglect leaves a paper trail, and paper travels a great deal further than any speech I could give. The floor is closer than I've let myself believe.",
                note_type="setback",
                image="images/journal/new_management/nm_pink_slips.webp",
                layout="photo_left",
            ),
            Teaser(
                "nm_clipboard_precedents",
                "Yuriko caught me with three grey-area questions, pen already uncapped.\nWhatever I answered was written down and doing the rounds before lunch.",
                OR(
                    EventSeenCondition(True, "nm_testing_the_waters_clipboard"),
                    EventSeenCondition(True, "nm_testing_the_waters_memo"),
                ),
                interpretation="She wasn't curious — she was mapping me. Every offhand reply I give her hardens into policy she can quote back at me later. I need to know what I actually think {i}before{/i} she asks, not after.",
                note_type="suspicion",
            ),
            Teaser(
                "nm_face_sticks",
                "In the kiosk queue, Aona stopped herself mid-sentence: \"That's him — from the assembly. I remember now.\"\nThe same girl who once had me pegged as the maintenance man.",
                EventSeenCondition(True, "nm_rumors_in_bloom_kiosk"),
                interpretation="There it is — the face finally catching up with the title, out loud, in front of her friends. They don't just quietly learn who I am; they re-label me in public, and that version sticks. Feels like a corner turned.",
                note_type="observation",
            ),
            # PHOTO: the chalk portrait on the bike-shed brick — rough, cartoonish,
            # unmistakably the headmaster, and oddly flattering.
            Teaser(
                "nm_chalk_portrait",
                "Someone chalked a portrait of me onto the bike-shed brick.\nRough work — and flattering, which is what caught me off guard.",
                EventSeenCondition(True, "nm_rumors_in_bloom_chalk"),
                interpretation="A month ago they weren't certain I existed; now I'm turning up drawn on walls, and drawn {i}kindly{/i} at that. When the version of you the gossip sketches is a fond one, half the work's already done. I could do a lot worse than live up to it.",
                note_type="observation",
                image="images/journal/new_management/nm_chalk_portrait.webp",
                layout="photo_right",
            ),
            Teaser(
                "nm_yulan_thaw",
                "Yulan stopped me between periods — folder closed, for once.\n\"The students are settling,\" she said, quietly. \"Be patient with the parts that still shake.\"",
                OR(
                    EventSeenCondition(True, "nm_thresh_yulan_thaw"),
                    EventSeenCondition(True, "nm_thresh_first_warmth"),
                ),
                interpretation="From Yulan, that's very nearly warmth. She didn't announce anything — she just let a little of the cold out, deliberately, where I'd catch it. This place doesn't thaw all at once. It thaws in pieces, and I think I just earned one.",
                note_type="insight",
            ),
            Teaser(
                "nm_care_channel",
                "Miwa hung back after the bell only to thank me, and was gone before I could answer.\nLily returned my outline with two words in the margin: \"Actually… better.\"",
                OR(
                ...
                interpretation="Something's turned. The care I've been putting in is starting to come back the other way — unasked, unforced. They've decided I'm someone you can bring a small good thing to without it being strange. That's the whole job, quietly doing its work.",
                note_type="insight",
            ),
            # PHOTO: the finished engraved brass plaque, the headmaster's name spelled
            # right, catching the hall light. Bookends nm_wrong_face.
            Teaser(
                "nm_title_earned",
                "The brass plaque finally came — my name cut into it, and this time spelled right.\nIn the staff room, Finola raised a mug \"to surviving the first week, headmaster.\"",
                OR(
                ...
                interpretation="Somewhere along the line they quietly dropped the word 'new' from in front of my title. Not in a speech — just in the ordinary way they say it now, plaque and mug and morning line all agreeing on the same thing. I'm the headmaster here. Theirs. It took long enough to feel true.",
                note_type="insight",
                image="images/journal/new_management/nm_title_earned.webp",
                layout="photo_top",
            ),
