...
label nm_ghost_office_nameplate (**kwargs):
    ...
    # Establishing beat: the door is the subject, not a conversation → scene image.
...
label .fix (**kwargs):
    ...
    headmaster_thought "It's only a name on a door. But it's the first thing anyone reads about who's supposed to be in charge here."
...
label .charm_fix (**kwargs):
    ...
    headmaster_thought "The plaque was never really the point. The point is the second coffee — that she poured it without thinking, that she's already on my side of the desk."
...
label .leave_it (**kwargs):
    ...
    $ emiko.display(PDAImage(mood = "pout", mouth = "closed"))
    ...
    headmaster_thought "I told myself 'temporary.' Somehow the whole school heard 'optional.'"
...
label .walk_away (**kwargs):
    ...
    headmaster_thought "If I can't be bothered to claim my own door, why would anyone else hand me the room behind it?"
...
label nm_ghost_office_janitor (**kwargs):
    ...
    headmaster_thought "They've got the title, all right. They just never got a face to pin it to."
...
label .introduce (**kwargs):
    ...
    headmaster_thought "Mortifying for her. Perfect for me. {i}This{/i} is the version she'll be retelling at lunch."
...
label .door (**kwargs):
    ...
    headmaster_thought "Didn't have to win that one myself. That's the entire reason you put your name on the door."
...
label .slip_past (**kwargs):
    ...
    headmaster_thought "No need to make a scene of it. They'll see me tomorrow, and the day after that. The face sticks eventually."
...
label .snap (**kwargs):
    ...
    headmaster_thought "They scattered fast enough. But that was flinching, not respect. I know the difference — even if they don't, yet."
...
label nm_ghost_office_private_line (**kwargs):
    ...
    headmaster_thought "There's a smile in her voice she'd never let anywhere near her face at the desk."
...
label .triage (**kwargs):
    ...
    headmaster_thought "She's already carrying half of this by herself. All I have to do is show up for the other half — and the whole school clocks it the second I do."
...
label .honest (**kwargs):
    ...
    headmaster_thought "No lecture, no I-told-you-so. Just the truth, handed over gently. Somehow that lands harder than a shout would have."
...
label .short (**kwargs):
    ...
    headmaster_thought "Clipped, polite, done. She left a little space at the end of that — and I walked straight past it."
...
label .distant (**kwargs):
    ...
    headmaster_thought "She reached out warm, and I answered like a dial tone. She's still holding that somewhere, with nowhere to set it down."
...
label nm_ghost_office_empty_corridor (**kwargs):
    ...
    if face_known:
        ...
        headmaster_thought "The face I planted down in the courtyard made its own way up here. I didn't have to carry it."
    else:
        headmaster_thought "The silence is the verdict. Staff don't hand out titles on the strength of a hello in a hallway."
...
label .acknowledge (**kwargs):
    ...
    headmaster_thought "That's a crack in the ice. Hairline-thin — but it's real, and it's the first one I've managed."
...
label .shop (**kwargs):
    ...
    headmaster_thought "You don't warm Yulan up with charm. You earn her by knowing the work as well as she does."
...
label .greet (**kwargs):
    ...
    $ yulan.display(PDAImage(mood = "neutral", mouth = "open"))
    yulan.say "Headmaster."
    headmaster_thought "One word, no warmth behind it. But it was the right word — and last week I wouldn't have gotten even that much."
...
label .force (**kwargs):
    ...
    headmaster_thought "I walked past her like she was part of the wall. And Yulan is not the type to forget being treated like furniture."
...
label nm_potion_hangover_miwa (**kwargs):
    ...
    if emiko_close:
        headmaster_thought "Emiko flagged this one on the phone. 'The Igarashi girl — keep half an eye.' She's usually right about who's about to fall through a crack."
    ...
    headmaster_thought "Same gap she named the day the potion went round. Weeks on, and it's never once occurred to anyone to just hand her the day back."
...
label .press (**kwargs):
    ...
    headmaster_thought "I asked a hole to account for itself. It won't. It only gets deeper when you shine a light straight down it."
...
label nm_potion_hangover_lily (**kwargs):
    ...
    headmaster_thought "This isn't a scandal. It's a competent adult, badly rattled, asking to be believed for thirty seconds."
...
label .sit (**kwargs):
    ...
    headmaster_thought "Nothing to fix. She only needed the week to be real in someone else's mouth as well as her own."
...
label .loop_in (**kwargs):
    ...
    headmaster_thought "Emiko's discretion, spent well. Believing Lily is kind. Handing her proof is a floor to stand on."
...
label .maybe (**kwargs):
    ...
    headmaster_thought "Not the whole answer. But a hinge, and a date on the calendar. She can hang the week on that until it makes sense."
...
label .deflect (**kwargs):
    ...
    headmaster_thought "I took her one brave question and turned it into a punchline. She won't be bringing it back to me."
...
label nm_potion_hangover_vial (**kwargs):
    ...
    headmaster_thought "The evidence never actually left. It just stopped being obvious enough to trip anyone up."
    ...
    headmaster_thought "The exact same smell. Whatever this stuff is, it has already walked these halls once — with an audience."
...
label .bag (**kwargs):
    ...
    headmaster_thought "Not a flicker of surprise. Just procedure. She's been quietly waiting for one of these to surface again."
...
label .note (**kwargs):
    ...
    headmaster_thought "Documented. Contained. Not a panic — but on paper now, where a panic can't come back later and quietly rewrite it."
...
label .ignore (**kwargs):
    ...
    headmaster_thought "Looking away is a decision too. Keep making it, and sooner or later the school starts making the harder ones in my place."
