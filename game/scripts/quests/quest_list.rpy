...
label load_quests:
    ...
    $ quest_manager.load_quest(
        Quest(
            ...
            {"init": [VisibleAction("quest", "aonas_new_bra")]},
            Goal(
                "aona_bra_event_1", 
                "Sports class",
                "Teach some P.E. until you find out, what's the Problem.",
                {
                    "init": [VisibleAction("goal", "aona_bra_event_1")],
                    "complete": [VisibleAction("goal", "aona_bra_event_2")],
                },
                EventTask(
                    "aona_bra_task_1",
                    "aona_bra_task_1",
                    "Teach some P.E.",
                    {"init": [VisibleAction("task", "aona_bra_task_1"), ActivateAction("aona_bra_task_1")]},
                    "gym_teach_pe_main_aona_bra",
                ),
            ),
            Goal(
                "aona_bra_event_2", 
                "Aona needs a new Bra!",
                "Drive Aona to the Shop.",
                {
                    "visible": [VisibleAction("task", "aona_bra_task_2"), ActivateAction("aona_bra_task_2")],
                    "complete": [VisibleAction("goal", "aona_bra_event_3")],
                },
                EventTask(
                    "aona_bra_task_2",
                    "aona_bra_task_2",
            ...
            Goal(
                "aona_bra_event_3", 
                "Aona and her new Bra!",
                "Check if Aona is happy with her new bra.",
                {
                    "visible": [VisibleAction("task", "aona_bra_task_3"), ActivateAction("aona_bra_task_3")],
                },
                EventTask(
                    "aona_bra_task_3",
                    "aona_bra_task_3",
