...
label tutorial_map:
    ...
    show screen show_building_hovered("Sports Field")
    ...
    show screen show_building_hovered("Tennis Court")
    ...
    show screen show_building_hovered("Gym")
    ...
    show screen show_building_hovered("Pool")
    ...
    show screen show_building_hovered("Bath")
    ...
    show screen show_building_hovered("Cafeteria")
    ...
    show screen show_building_hovered("Office Building")
