...
init -1 python:
    ...
    tennis_court_events = {
        ...
        "peek_changing":  EventStorage("peek_changing",  "Peek into the changing rooms", "tennis_court", default_fallback, "There is nobody here."),
        "enter_changing": EventStorage("enter_changing", "Enter changing rooms",         "tennis_court", default_fallback, "There is nobody here."),
        "steal_changing": EventStorage("steal_changing", "Steal some panties",           "tennis_court", default_fallback, "There is nobody here."),
    }
